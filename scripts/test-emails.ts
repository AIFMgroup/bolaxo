/**
 * Test script for Afterfounder email system
...
const BASE_URL = process.env.NEXT_PUBLIC_BASE_URL || 'https://afterfounder.com'

async function runTests() {
  console.log('🧪 Starting Afterfounder Email System Tests')
  console.log('====================================')
