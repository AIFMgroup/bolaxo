        ...
        <View style={styles.section}>
          ...
          <View style={{ ...styles.executiveBox, marginTop: 20 }}>
            ...
            <View style={{ marginTop: 15, borderTop: '1 solid rgba(255,255,255,0.3)', paddingTop: 15 }}>
              ...
              <Text style={styles.executiveText}>✉ kontakt@bolaxo.com</Text>
              <Text style={styles.executiveText}>🌐 www.bolaxo.com</Text>
        ...
        <View style={styles.section}>
          ...
          <View style={{ marginTop: 15, backgroundColor: '#1F3C58', padding: 15, borderRadius: 6 }}>
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'center', marginTop: 10 }}>
              <Text style={{ fontSize: 8, color: '#FFFFFF', marginHorizontal: 10 }}>✉ kontakt@bolaxo.com</Text>
              <Text style={{ fontSize: 8, color: '#FFFFFF', marginHorizontal: 10 }}>🌐 www.bolaxo.com</Text>
            </View>
